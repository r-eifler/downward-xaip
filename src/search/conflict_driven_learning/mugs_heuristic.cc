...
#ifndef NDEBUG
        auto mugs_before = get_mugs_set();
#endif
        if (max_achieved_subgoals_.insert(sg, on_removed_)) {
            on_added_subgoal(sg);
        }
#ifndef NDEBUG
        auto mugs_after = get_mugs_set();
...
void
MugsHeuristic::print_statistics() const
{
    utils::Timer t;
...
//    mugs_store.output_mugs("test");
    ...
    std::cout << "*********************************"  << std::endl;
    std::cout << "#MSGS: " << max_achieved_subgoals_.size() << std::endl;
    std::cout << "*********************************"  << std::endl;
    print_set(max_achieved_subgoals_.begin(), max_achieved_subgoals_.end());
    std::cout << "*********************************"  << std::endl;
    std::cout << "#MUGS: " << mugs.size() << std::endl;
    std::cout << "*********************************"  << std::endl;
    print_set(mugs.begin(), mugs.end());
    std::cout << "*********************************"  << std::endl;
    print_set(mugs.begin(), mugs.end(), goal_fact_names_, hard_goal_);
    std::cout << "*********************************"  << std::endl;
}
